...
class SimulatorNode():
    ...
    def OnStep(self, request):
        ...
        try:
            ...
            if self.step == 0:
                # BUY
                if self.border + self.x + 2 * self.xStep > self.m_width:
                    ...
                    # Normal cases
                    if self.passStep == 0 or self.passStep == 1:
                        self.x += 2 * self.xStep
                    if self.passStep == 2:
                        self.passStep = 3
                    if self.passStep == 3:
                ...
                if self.passStep == 1:
                    ...
                    #jt edit
                    self.m_X = self.x + self.xStep + self.border
                    self.m_Y = self.y + self.border
                    result += str("<log> x value: " + str(self.m_X) + "</log>")
                ...
                if self.passStep == 3:
                    ...
                    while bought == False:
                        try:
                            ...
                            while (self.cells_dict[(self.border + self.x, self.border + self.y)].m_production \
                            + self.cells_dict[(self.border + self.x + self.xStep,self.border + self.y)].m_production \
                            + self.cells_dict[(self.border + self.x,self.border + self.y + self.yStep)].m_production \
                            + self.cells_dict[(self.border + self.x + self.xStep,self.border + self.y + self.yStep)].m_production >= 100) == False:
                                self.x += self.xStep
                ...
                if self.passStep == 0 or self.passStep == 2:
